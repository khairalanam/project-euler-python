"""
In the 20x20 grid below, four numbers along a diagonal line have been marked in brackets.
...
def find_largest_product(grid: list[list[int]]):
    ...
    return max([product_vertical, product_horizontal, product_diagonal])
